   ...
   <body>
      ...
      <div class="banner_bg_main">
         ...
         <div class="logo_section">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                    <div class="logo"><a href="{{route('Home')}}"><h1 style="font-weight: bolder">eshop</h1></a></div>
                  </div>
               </div>
            </div>
         </div>
                     ...
                     <div class="login_menu">
                        <ul>
                           <li><a href="#">
                              ...
                              <span class="padding_10">Корзина</span></a>
                           </li>
                           <li><a href="#">
                              <i class="fa fa-user" aria-hidden="true"></i>
                              <span class="padding_10">Профиль</span></a>
                           </li>
                        </ul>
                     </div>
                  </div>
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            ...
            <div class="location_main">Поддержка : <a href="https://github.com/qiwoo">Semyon Biryukov</a></div>
         </div>
      </div>
